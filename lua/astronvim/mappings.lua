...
maps.v["<leader>y"] = { '"+y' }
-- copy full file
maps.n["<leader>Y"] = { 'ggVG"+y', desc = "copy full file to system clipboard" }
-- Normal --
-- Standard Operations
...
-- zen mode
maps.n["<leader>z"] = { function() require("zen-mode").toggle {} end, desc = "Zen Mode" }
-- AstroNvim
...
if is_available "gitsigns.nvim" then
  ...
  maps.n["<leader>gd"] = { "<cmd>DiffviewFileHistory %<cr>", desc = "diff current file" }
end
...
if is_available "telescope.nvim" then
  ...
  maps.v["<leader>fw"] = { function() require("telescope.builtin").grep_string() end, desc = "Find words" }
  maps.n["<leader>fW"] = {
    function()
...
if is_available "toggleterm.nvim" then
  ...
  maps.n["<leader>tn"] = { "<cmd>vsplit | term<cr>", desc = "split terminal" }
  ...
  maps.n["<C-'>"] = { "<cmd>1ToggleTerm direction=float<cr>", desc = "ToggleTerm float" }
  maps.n["<C-;>"] = { "<cmd>2ToggleTerm direction=horizontal<cr>", desc = "ToggleTerm horizontal split" }
